...
The recommended way to install Ruby on a new system is via [rbenv](https://github.com/rbenv/rbenv). Here are 2 ways to install rbenv:
...
* [rvm](https://rvm.io/) is also a ruby version manager similar to rbenv and is another way to install and manage multiple versions of ruby.
